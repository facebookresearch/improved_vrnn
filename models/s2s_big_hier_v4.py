...
class Model(nn.Module):
    ...
    def forward(self, frames, config, use_prior, use_mean=False, scale_var=1.):
        ...
        q_dists = self.posterior(emb, emb, use_mean=use_mean, scale_var=scale_var)
        p_dists = self.prior(emb, emb, q_dists, use_prior, use_mean=use_mean, scale_var=scale_var)
